...
import kotlinx.android.synthetic.main.activity_daftar_kuliner_user.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class DaftarKulinerUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_daftar_kuliner_user)
    ...
    private fun setupRecycleView() {
        daftarKulinerAdapter = DaftarKulinerAdapter(arrayListOf(), object: DaftarKulinerAdapter.OnAdapterListener {
            override fun onClick(result: KulinerModel) {
                startActivity(
                    Intent( applicationContext, DetailKulinerUser::class.java )
